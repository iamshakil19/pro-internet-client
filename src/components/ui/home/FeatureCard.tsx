...
import shared from "../../../assets/feature-card/shared.png";
import reseller from "../../../assets/feature-card/reseller.png";
import domain from "../../../assets/feature-card/domain.png";
import cloud from "../../../assets/feature-card/managed-cloud.png";
import Image from "next/image";

const FeatureCard = () => {
  return (
    <div className="container p-5 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
      <div
      ...
      >
        ...
        <p className="mt-2">
          Ideal for getting started before moving on to a more advanced hosting
          package
        </p>
        <p className="mt-4 text-lg">
          Starting at <br /> <span className="text-2xl font-bold">120 BDT</span>{" "}
          /mo
        </p>
